...
This module owns the persisted public edge configuration stored under
``Engine/LetsEncrypt/Settings.json``. Borealis.sh uses it to create/update the
...
DEFAULT_SETTINGS_PATH = PROJECT_ROOT / "Engine" / "LetsEncrypt" / "Settings.json"
DEFAULT_ACME_STORAGE_PATH = PROJECT_ROOT / "Engine" / "LetsEncrypt" / "acme.json"
DEFAULT_RUNTIME_ENV_PATH = PROJECT_ROOT / "Engine" / "LetsEncrypt" / "runtime.env"
DEFAULT_TRAEFIK_ROOT = PROJECT_ROOT / "Engine" / "Traefik"
...
def _default_settings(
    *,
    ...
    return LetsEncryptSettings(
        ...
        logs_directory=str(PROJECT_ROOT / "Engine" / "Logs"),
    )
