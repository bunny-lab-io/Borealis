/*
 * Apache Guacamole guacamole-common-js 1.6.0
 * Vendored from official Apache source release:
 * https://downloads.apache.org/guacamole/1.6.0/source/guacamole-client-1.6.0.tar.gz
 */

const windowRef = typeof window !== "undefined" ? window : globalThis;
let Guacamole = windowRef.Guacamole || {};
windowRef.Guacamole = Guacamole;
