...
??? example "Detailed Codex Breakdown"
    ...
    - Node manager accepts fixed verbs only, including persistent K3s membership fence and exact-version probe conformance. It never exposes arbitrary command or remote-shell execution.
