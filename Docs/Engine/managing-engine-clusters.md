...
??? example "Detailed Codex Breakdown"
    ...
    - `Data/Engine/K3s/cluster/repair-legacy-admission.py` is an explicit root-run compatibility command for baseline `d94708b7220e79c223fa74fe17db2e3470b42d69`, tracked in #517. It verifies clean application/repair checkouts and origin, published immutable release/tag/SHA/channel/manifest and baseline ancestry. It checks the endpoint against local runtime configuration before reading or sending the Admin token.
