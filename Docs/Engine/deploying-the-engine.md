...
During deployment, Borealis installs missing dependencies, prepares runtime configuration, builds changed service container images, and starts the Docker Compose stack automatically.
