...
??? example "Detailed Codex Breakdown"
    ...
    - Engine public API source code: `Data/Engine/Containers/api-backend/cmd/api-backend/`; retained Python worker support: `Data/Engine/Containers/api-backend/data/`.
