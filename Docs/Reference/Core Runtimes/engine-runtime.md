...
- K3s baseline and operator bridge: `Engine.sh` installs and reconciles a single-node K3s control plane plus restricted `borealis-operator` workload for migration bridge work.
