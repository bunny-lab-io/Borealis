...
- `site-worker-orchestrator` has write Docker socket access for legacy Docker drains and scoped service-action helpers. No other static service mounts the Docker socket.
