...
| shared-engine | iproute2 `ip` (Ubuntu host-provided; read-only SSH IPv4 address/route/rule observations) | [GPL-2.0-or-later](https://github.com/iproute2/iproute2/blob/main/COPYING) |
