...
1. Port Directory Services mutations and directory-login pending-state handling to Go, then delete retained Python directory routes.
2. Port scheduler protected-secret helper paths and workflow/onboarding credential consumers so internal Python Aegis bridge can be deleted.
