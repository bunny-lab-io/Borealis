...
| `GET /api/bootstrap/cluster/join/{id}/events` | `public-bootstrap` | `bootstrap-contract` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:132` |
...
| `GET /api/server/cluster` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:113` |
| `GET /api/server/cluster/banner` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:114` |
| `GET /api/server/cluster/events` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:115` |
| `GET /api/server/cluster/releases` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:116` |
...
| `POST /api/bootstrap/cluster/join` | `public-bootstrap` | `bootstrap-contract` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:131` |
...
| `POST /api/server/cluster/admissions/{id}/approve` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:119` |
| `POST /api/server/cluster/admissions/{id}/cancel` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:120` |
| `POST /api/server/cluster/enable` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:117` |
| `POST /api/server/cluster/hmr/exit` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:127` |
| `POST /api/server/cluster/hmr/start` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:126` |
| `POST /api/server/cluster/invitations` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:118` |
| `POST /api/server/cluster/membership/scale` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:121` |
| `POST /api/server/cluster/nodes/{id}/maintenance` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:122` |
| `POST /api/server/cluster/nodes/{id}/remove` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:123` |
| `POST /api/server/cluster/operations/{id}/cancel` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:130` |
| `POST /api/server/cluster/operations/{id}/retry` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:129` |
| `POST /api/server/cluster/postgres/emergency-failover` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:125` |
| `POST /api/server/cluster/postgres/switchover` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:124` |
| `POST /api/server/cluster/updates` | `operator-api` | `operator-session` | `Data/Engine/Containers/api-backend/cmd/api-backend/server_cluster.go:128` |
