...
??? example "Detailed Codex Breakdown"
    ...
    - `GET /api/server/site-worker-settings` (Admin) - read the persisted site-worker scheduled-lane task concurrency limit.
    - `PUT /api/server/site-worker-settings` (Admin) - update the persisted site-worker scheduled-lane task concurrency limit.
