...
<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Device_List.png" alt="Borealis Device Inventory page" loading="lazy">
...
<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Device_Details.png" alt="Borealis Device Summary page" loading="lazy">
...
<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Device_Details_Agent_Health.png" alt="Borealis Agent Health tab" loading="lazy">
...
<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/User_Site_Assignment.png" alt="Borealis User Site Assignment page" loading="lazy">
...
<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Device_Filter_Editor.png" alt="Borealis Device Filter Editor" loading="lazy">
  <figcaption>Device Filter Editor defines criteria and site scope for dynamic endpoint matching.</figcaption>
</figure>

<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Device_Service_List.png" alt="Borealis Device Service List" loading="lazy">
  <figcaption>Service inventory shows cached service state and supports service management actions for devices.</figcaption>
</figure>

<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Device_Process_Manager.png" alt="Borealis Device Process Manager" loading="lazy">
...
<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Device_Process_Manager_Terminated_Tasks.png" alt="Borealis terminated tasks process view" loading="lazy">
...
<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Remote_Desktop.png" alt="Borealis Remote Desktop session" loading="lazy">
...
<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Credential_Management_Editor.png" alt="Borealis Credential Management Editor" loading="lazy">
...
<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Directory_Services.png" alt="Borealis Directory Services page" loading="lazy">
...
<figure class="bo-screenshot">
  <img src="../images/repo_screenshots/Agent_System_Tray.png" alt="Borealis Agent system tray" loading="lazy">
