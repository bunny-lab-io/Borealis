...
- `internal/roles/deviceaudit` - core CPU, memory, storage media type, removable media, network link speed, OS/build, hardware model/serial, last reboot, internal IP, device type, uptime, and last-user inventory published through heartbeat payloads.
