...
??? example "Detailed Codex Breakdown"
    ...
    - VNC and RDP firewall commands inspect Borealis-owned rule description, protocol, port, and address filters. Matching rules remain untouched; drifted rules are replaced. Readiness logs include lock, enablement, firewall, config, service, and listener phase durations. PowerShell failures include captured command output.
