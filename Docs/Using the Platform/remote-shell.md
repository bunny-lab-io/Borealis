...
??? example "Detailed Codex Breakdown"
    ...
    - Shell bridge/runtime: `Data/Engine/Containers/site-worker/data/services/job_scheduler/worker_socket.py` and `Data/Engine/Containers/site-worker/data/services/WebSocket/vpn_shell.py`
    - Tunnel service: `Data/Engine/Containers/api-backend/cmd/api-backend/vpn_tunnel.go`
